<template>
  <el-container>
    ...
    <el-aside width="200px">
      <el-menu :default-openeds="['2']" :default-active="menuIndex">
        <el-submenu index="2">
          <template slot="title">运营管理</template>
          <el-menu-item-group>
            <el-menu-item index="1-0" @click="onMenuChange('message')">留言板</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <el-menu-item index="1-1" @click="onMenuChange('notice')">闪屏公告</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <el-menu-item index="1-2" @click="onMenuChange('update')">版本更新</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <el-menu-item index="1-3" @click="onMenuChange('users')">用户列表</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
      </el-menu>
    </el-aside>
...
<style scoped>
  ...
  .el-header {
    ...
    /*background-color: rgb(58,88,204); */
